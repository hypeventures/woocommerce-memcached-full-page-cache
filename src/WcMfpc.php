...
class WcMfpc extends WcMfpcAbstract
{
    ...
    public function plugin_post_init()
    {
        ...
        add_filter('contextual_help', [ &$this, 'plugin_admin_nginx_help' ], 10, 2);
    }
    ...
    set $memcached_key DATAPREFIX$memcached_sha1_key;';
        ...
        $to_replace   = [ 'DATAPREFIX', 'KEYFORMAT', 'SERVERROOT', 'SERVERLOG' ];
        $replace_with = [ $this->options[ 'prefix_data' ], $this->options[ 'key' ], ABSPATH, $_SERVER[ 'SERVER_NAME' ] ];
        ...
        if ($this->options[ 'nocache_cookies' ]) {
            ...
            $cookie_exception = '
                # avoid cache for cookies specified
